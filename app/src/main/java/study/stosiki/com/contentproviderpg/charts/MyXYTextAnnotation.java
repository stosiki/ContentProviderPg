 ...
 * {@link XYPlot}.
 */
public class MyXYTextAnnotation extends AbstractXYAnnotation
...
//    public static final Paint DEFAULT_PAINT = Color.black;
     ...
     */
    public MyXYTextAnnotation(String text, double x, double y) {
        if (text == null) {
    ...
    public void draw(Canvas canvas, XYPlot plot, RectShape dataArea,
        ...
        PaintUtility.updatePaint(paint, new SolidColor(Color.BLACK));
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof MyXYTextAnnotation)) {
            return false;
        }
        MyXYTextAnnotation that = (MyXYTextAnnotation) obj;
